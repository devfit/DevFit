...
(function() {
	 ...
	 */
	angular.module('devfit.home.assistance', [
	...
	.config(function config($stateProvider) {
		$stateProvider.state('home.assistance', {
			url: '/assistance',
			views: {
				'assistance-tab': {
					controller: 'AssistanceCtrl as vm',
					templateUrl: 'home/assistance/assistance.tpl.html'
				}
			}
		});
	})
